...
public interface medicalCenterInterface {

    String EXIT = "0";
    String ADD_DOCTOR= "1";
    String SEARCH_DOCTOR_BY_PROFESSION = "2";
    String DELETE_DOCTOR_BY_ID = "3";
    String CHANGE_DOCTOR_INFO_BY_ID = "4";
    ...
    static void printCommands(){
        ...
        System.out.println("Please input " + CHANGE_DOCTOR_INFO_BY_ID + " for CHANGE_DOCTOR_INFO_BY_ID");
        ...
        System.out.println("Please input " + PRINT_ALL_PATIENTS + " for PRINT_ALL_PATIENT");
    }
}
